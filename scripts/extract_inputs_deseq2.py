...
from reli_utils import (
    ...
    write_null_model, validate_null_model,
)
...
def expand_bed_to_null_model(bed_path, null_model_path, chrom_offsets):
    ...
    Thin wrapper around reli_utils functions. Maintains the original interface
    and print output for backward compatibility.
    """
...
def main():
    ...
    print(f"  Note: --input-dir mode produces consolidated TSVs in per-query subdirectories.")
