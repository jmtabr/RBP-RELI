#!/usr/bin/env python3
"""
NAR 2022-style RBP-RELI bar plot: 3 columns x 2 rows with exon schematic.
...
# ---------------------------------------------------------------------------
# rcParams: journal-standard fonts and line weights (set once at import)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Print-scale font sizes (Nature/Cell single-column ready)
# ---------------------------------------------------------------------------
FONT = {
    "title": 10,
    "subtitle": 9,
...
DOUBLE_COL = 7.2  # 183 mm Nature double column
DPI = 300
...
def parse_args():
    p = argparse.ArgumentParser(
        description="Generate NAR 2022-style RBP-RELI enrichment barplot.",
